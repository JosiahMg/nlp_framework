...
if __name__ == '__main__':
    ...
    embfile = './corpus/tianchi_news/word2vec.txt'
    ...
    train_dataset = NewsDataset(train_data, front=True)
    val_dataset = NewsDataset(val_data, front=True)
    test_dataset = NewsDataset(test_data, front=True)
    ...
    trainer.fit(train_dataloader, val_dataloader, resume=True)
